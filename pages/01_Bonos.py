...
def cargar_datos():
    ...
    for ruta in archivos_csv:
        ...
        # Si el archivo es un temporal de Excel, lo ignoramos
        ...
        # --- DROP DUPLICATES AQUÍ (Limpieza por archivo) ---
    ...
    # --- SEGUNDO DROP DUPLICATES (Limpieza global) ---
    # Esto elimina registros si el mismo movimiento está en dos archivos distintos
    df_mov = df_mov.drop_duplicates(subset=['Ticker', 'Operado', 'Operación', 'Cantidad', 'Precio'])
    
    return df_mov

# --- 2. FUNCIÓN DE CARGA DE ENTORNO ---
def cargar_entorno():
